...
export function getArticlesByFilter(filter, value, page_no, page_size) {
  return request(
    api.article.getArticlesByFilter.url(filter, value, page_no, page_size),
...
export function searchArticles(filter, value, page_no, page_size) {
  return request(
    api.article.searchArticles.url(filter, value, page_no, page_size),
    api.article.searchArticles.method,
    {},
    {}
  );
}
